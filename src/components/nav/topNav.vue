	...
	<el-row class="container">
		...
		<el-col :span="24" class="topbar-wrap">
			<div class="topbar-logo topbar-btn">
				<a href="/">
					<img src="https://wy.010zh.cn/web/static/img/logo.png" alt="">
<!--					<img src="../../assets/logo-1.png" style="padding-left:15px;" />-->
				</a>
			</div>
			<div class="topbar-logos">
				<a href="Javascript:;" style="color: #fff;">
					<span v-show="!$store.state.collapsed">怀仁328评审平台</span>
				</a>
			</div>
				...
				<el-row v-show="$store.state.topNavState==='home'">
					<el-col :span="24">
						<el-menu
							...
							:router="true"
						>
							<el-menu-item index="/home">案例展示</el-menu-item>
							<el-menu-item index="/myTeam">我的评审组</el-menu-item>
<!--							<el-menu-item index="/myVote">我已评审</el-menu-item>-->
						</el-menu>
					</el-col>
				</el-row>
...
<!--							<el-menu-item index="/myTeam">我的评审组</el-menu-item>-->
<!--&lt;!&ndash;							<el-menu-item index="/myVote">我已评审</el-menu-item>&ndash;&gt;-->
<!--						</el-menu>-->
<!--					</el-col>-->
<!--				</el-row>-->
			</div>
